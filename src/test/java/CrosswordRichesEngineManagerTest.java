...
public class CrosswordRichesEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(CrosswordRichesEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/CrosswordRiches/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CrosswordRiches/InitOutcome.xml").getDocumentElement();
